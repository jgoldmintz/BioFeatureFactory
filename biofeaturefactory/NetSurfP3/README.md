...
1. Clone NetSurfP-3.0 into the `nsp3/` subdirectory (see section2)
...
### 5.1 Summary TSV (`{GENE}.netsurfp3.summary.tsv`)
...
### 5.2 Per-Residue TSV (`{GENE}.netsurfp3.residues.tsv`)
...
### 5.3 Local Changes TSV (`{GENE}.netsurfp3.local.tsv`)
