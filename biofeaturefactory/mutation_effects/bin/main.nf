...
workflow {
    ...
    if (!params.skip_evmutation) {
        ...
        // Step 4: Codon EVmutation — gated on !skip_codon_evmutation.
        if (!params.skip_codon_evmutation) {
...
process run_protein_adabmdca {
    ...
    python3 ${projectDir}/../adabmdca_pipeline.py \\
        ...
        --adabmdca-nepochs ${params.adabmdca_nepochs} \\
